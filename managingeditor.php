        ...
        $(function() {
            ...
            $("#downloadimage").click(function() { 
              ...
              alert("hello");
               ...
               html2canvas($("#editorcontents"), {
                    onrendered: function(canvas) {

                        // Convert and download as image 
                        Canvas2Image.saveAsPNG(canvas); 
                        $("#editorcontents").append(canvas);
                        // Clean up 
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Merge articles and images here</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
              ...
              <p>
                ...
                <div id="contents" style="display: none">
                  ...
                  <div id="editorcontents" style="border:1px solid black; ">
                  </div>
                </div>
                  <input type="button" id="downloadimage" value="Generate Image">
