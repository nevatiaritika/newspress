                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                                  ...
                                                  mysql_select_db('ndb');
                                                  $query="SELECT articles.article_date, articles.article_name,article_writer_r.writer_id,articles.article_category,articles.article_type from articles INNER JOIN article_writer_r ON articles.article_id=article_writer_r.article_id ";
                                        ...
                                        <tr class="odd gradeX">
                                            <td><?php echo $row[0]; 
                                                $abc="articles/".$row[1];
                                            ?></td>
                                            <td><a href=<?php echo $abc;?>><?php echo $row[1]; ?></a></td>
